  ...
  return (
    ...
    >
      ...
      <div className="container-custom relative">
        <SectionTitle
          eyebrow="Experience"
          title="Professional journey in full-stack and mobile development"
          description="A timeline of my work across web applications, backend systems, mobile development, authentication workflows, and production-focused UI engineering."
        />
        ...
        >
          <div className="absolute left-5.25 top-0 hidden h-full w-px bg-linear-to-b from-indigo-500/80 via-violet-500/70 to-fuchsia-500/80 sm:block" />
          <div className="absolute left-5.25 top-0 hidden h-full w-px blur-[6px] bg-linear-to-b from-indigo-500/60 via-violet-500/60 to-fuchsia-500/60 sm:block" />
...
function ExperienceCard({
  ...
  return (
    <div className="flex items-start gap-5 sm:gap-8">
      <div className="relative z-10 hidden h-11 w-11 shrink-0 items-center justify-center rounded-full border border-white/15 bg-linear-to-r from-indigo-500 via-violet-500 to-fuchsia-500 shadow-[0_0_25px_rgba(168,85,247,0.45)] sm:flex">
        <FiBriefcase className="text-lg text-white" />
      </div>

      <div className="group relative w-full overflow-hidden rounded-[28px] border border-white/10 bg-white/5 p-6 shadow-[0_12px_40px_rgba(0,0,0,0.28)] backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:border-indigo-400/30 hover:bg-white/[0.07] hover:shadow-[0_20px_60px_rgba(99,102,241,0.18)] sm:p-7 lg:p-8">
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(135deg,rgba(99,102,241,0.10),rgba(168,85,247,0.06),rgba(236,72,153,0.05))]" />
        <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-linear-to-r from-transparent via-white/20 to-transparent" />

        <div className="relative z-10">
          <div className="mb-5 flex h-11 w-11 items-center justify-center rounded-full border border-white/15 bg-linear-to-r from-indigo-500 via-violet-500 to-fuchsia-500 shadow-[0_0_25px_rgba(168,85,247,0.45)] sm:hidden">
            <FiBriefcase className="text-lg text-white" />
          </div>
          ...
          <ul className="mt-6 space-y-3">
            {item.points.map((point, i) => (
              ...
              >
                <FiCheckCircle className="mt-1 shrink-0 text-[15px] text-fuchsia-300" />
                <span>{point}</span>
              </li>
            ))}
          </ul>
